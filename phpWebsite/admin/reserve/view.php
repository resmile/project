<?php
  ...
  $sql="SELECT r.name, r.no AS 'no', r.tp_no, t.title AS 'title', r.number_of_people, r.inquiry_message, r.reserve_day, r.start_of_date, r.end_of_date, r.status from reserve r, travelpackages t where r.tp_no=t.no and r.no=$no";
